export const RedisKeys = {
    ...
    ledgerBuildLatest: (clientId: number) => `financial:ledger-build:latest:${clientId}`,
    ledgerMonthlyBuild: (clientId: number, period: string) => `financial:ledger-build:monthly:${clientId}:${period}`,
} as const;